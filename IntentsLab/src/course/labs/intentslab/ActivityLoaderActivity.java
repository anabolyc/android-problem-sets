...
public class ActivityLoaderActivity extends Activity {
	...
	static private final String EDIT_EXTRA_CODE = "edit_extra_code";
	...
	private void startImplicitActivation() {
		...
		Uri webpage = Uri.parse(mUserTextView.getText().toString());
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == GET_TEXT_REQUEST_CODE && resultCode == RESULT_OK) {
			String text = data.getStringExtra(EDIT_EXTRA_CODE); 
